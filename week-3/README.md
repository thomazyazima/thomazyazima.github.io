...
JavaScript is known as the "language of the web." It is a powerful object-oriented language (Ruby is as well). It is light-weight and can communicate with the browser, but it's also a language in it's own right. This week, we will introduce you to basic JavaScript syntax; we want you to feel comfortable with simple variables and functions.
